      ...
      <Carousel>
        <div>
          <img
            ...
            alt=" "
          />
          <p className="legend">cute kitten1</p>
        </div>
        <div>
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSKWvimuwbnQeG6e9qxMikCGVydPxikSuPETHKGhx3IVf1y48cO&usqp=CAU"
            alt=" "
          />
          <p className="legend">cute kitten2</p>
        </div>
        <div>
          <img
            src="https://media.graytvinc.com/images/810*455/Cats21.jpg"
            alt=" "
          />
          <p className="legend">cute kitten</p>
        </div>
        <div>
          <img
            src="https://d17fnq9dkz9hgj.cloudfront.net/uploads/2012/11/144365453-stop-kitten-biting-632x475.jpg"
            alt=" "
          />
          <p className="legend">cute kitten</p>
        </div>
        <div>
          <img
            src="https://cdn.pixabay.com/photo/2017/08/19/13/40/cat-2658608_960_720.jpg"
            alt=" "
          />
          <p className="legend">OKAY! THIS AIN'T cute kitten</p>
        </div>
      </Carousel>
    </div>
  );
